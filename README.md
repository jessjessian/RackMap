...
Last updated: 2025 · Single-page reference for the whole system
---
1. Quick Facts
Item	Value
...
⚙️ Developer	Irene (KLCII)	`ongirene@klc.edu.sg`	contact Irene	System maintenance, SKU mgmt, tech support
...
---
7. Key Rules
⏰ Sales Admin entry: within 24 hrs before delivery — not earlier.
📅 Warehouse placement: within 2 working days — physical and system.
🚫 Receiving corrections: Warehouse cannot self-edit → WhatsApp Sales Admin + photos.
📦 Ji: Warehouse-managed, up to 3 companies, excluded from available.
⚖️ Multi-weight: weight quantities must equal the batch total exactly.
🔄 Physical shelf position must match RackMap position exactly.
---
...
Open `github.com/irene-ong/rackmap` → `index.html` → pencil ✏️
`Ctrl+A` → delete → paste the entire new file
Commit changes
Wait 1–2 min (GitHub Pages rebuild)
On the live site: Ctrl+Shift+R (hard refresh)
...
---
Contact: Irene Ong · ongirene@klc.edu.sg · KLC Reimagineers / Jedi Consulting
